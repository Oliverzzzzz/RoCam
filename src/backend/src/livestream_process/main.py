...
from cv_process.main import HEIGHT, LIVE_STREAM_FRAME_SIZE, LIVE_STREAM_QUEUE_DEPTH, LIVE_STREAM_SHM_NAME, WIDTH
...
class LiveVideoProcess:
    ...
    def __init__(self):
        self._livestream_frames_receiver = IPCBufferReceiver(LIVE_STREAM_SHM_NAME, LIVE_STREAM_QUEUE_DEPTH, LIVE_STREAM_FRAME_SIZE)
        ...
        save_gst_pipeline_png(self._pipeline, "livestream_process_pipeline")
...
def run_livestream_process():
    ...
    livestream_process = LiveVideoProcess()
