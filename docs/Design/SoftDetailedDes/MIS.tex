...
\begin{center}
  \begin{tabular}{p{4cm} p{3cm} p{8cm}}
    ...
    osd\_data                   & OSDData $|$ null                  & On-screen display data, null if not available                   \\
...
The CV Process Module passes uncompressed frames to the Live Video Process
...
\begin{itemize}
  \item Nvidia Deepstream SDK library
\end{itemize}
...
include the access programs we need. Its full documentation is available at
