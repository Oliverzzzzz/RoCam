...
\begin{itemize}
  \item Video Stream Abstraction Module (\mref{mStream})
  \item CV Process Module (\mref{mCV}) for the OSDData type
  \item Recording Database Module (\mref{mRecord}) for the RecordingInfo type
\end{itemize}
...
\begin{itemize}
  \item CV Process Module (\mref{mCV}) for the BoundingBox type
