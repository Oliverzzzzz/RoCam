...
\begin{center}
  \begin{tabular}{p{3cm} p{4cm} p{4cm} p{3.5cm}}
    ...
    \textbf{Name}    & \textbf{In}                       & \textbf{Out}             & \textbf{Exceptions} \\
    \hline
    start\_transcode & recording: \texttt{RecordingInfo} & output\_video\_pipe: str & -                   \\
    \hline
  \end{tabular}
\end{center}
...
\begin{enumerate}
  ...
  \item What are the limitations of your solution? Put another way, given unlimited
        resources, what could you do to make the project better? (LO\_ProbSolutions) 1.
  ...
  \item Give a brief overview of other design solutions you considered. What are the
        ...
        1. seperate cv, display and transcode processes
        2. direct streaming of transcoded video to the browser
        3. simple hand rolled recording database
\end{enumerate}
