...
% >>> added: short, rubric-aligned preface, while keeping details in the link
...
% >>> added: a single sentence that explicitly says everything is in the link
All detailed timeline information is provided in the link above.
