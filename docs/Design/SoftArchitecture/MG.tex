...
This section records key architectural decisions made to satisfy the SRS.
For each decision, we summarize the intent, the modules responsible for the
...
In the traceability tables, each SRS requirement identifier (e.g.,
FR, SLR, SCR, IR, AUR, INT, RFR, PAR, AR/SR, EZ/PI/UPR/LR, EPE, RR, CR, AS)
is mapped to the module(s) responsible for implementing and supporting that
requirement.
