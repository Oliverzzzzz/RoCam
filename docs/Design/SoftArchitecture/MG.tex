...
In the traceability tables, each SRS requirement (FR/SLR/SCR/IR/AUR/INT) is
mapped to the modules responsible for implementing and verifying it. Where
requirements are cross-cutting (e.g., SCR-3 remote operation, RFR-1 error
reporting), they are intentionally traced to both interface modules (UI/API)
and the backend modules that provide the underlying behavior.
