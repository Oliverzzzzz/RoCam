...
\begin{itemize}[leftmargin=*]
  ...
  \item[SC-3] \emph{The vision and tracking pipeline shall run on an NVIDIA Jetson Orin
          Nano, or an equivalent NVIDIA Jetson-class embedded GPU module.}\\[2mm]
  ...
  \item[SC-4] \emph{The project shall reuse open-source components for computer vision,
          deep learning, media streaming/recording, containerization, and continuous
          integration, provided they meet the performance and verification criteria
          defined in Section~\ref{sec:reusable-components}.}\\[2mm]
